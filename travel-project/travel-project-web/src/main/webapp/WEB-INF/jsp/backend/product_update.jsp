...
<script>
    ...
    $(".myfile").fileinput({
        //上传的地址
        uploadUrl:"http://localhost:80/pic/upload1",
...
<script>
    ...
    editor.customConfig.uploadImgServer = 'http://localhost:80/pic/upload1'
    // 关闭粘贴样式的过滤
    ...
    editor2.customConfig.uploadImgServer = 'http://localhost:80/pic/upload1'
    // 关闭粘贴样式的过滤
...
//			alert(editor.txt.html());
        ...
        console.log(data);
        var targetUrl="http://localhost:80/manager/product/update/"+${product.pid};
        $.ajax({
            type:'post',
            url:targetUrl,
            cache: false,
            ...
            success:function(result){
                if(result.status==200){
                    alert("保存成功");
                    window.location.href="http://localhost:80/manager/product/listView";
                }
