...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">会员列表</h2>
            <a href="" class="fr top_rt_btn add_icon">添加新会员</a>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <label class="radio-inline">
                        <input type="radio" name="sex" id="inlineRadio1" value="male" ${user.sex=='male' ? 'checked' : ''}> 男
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="sex" id="inlineRadio2" value="female" ${user.sex=='female'?'checked' : ''}> 女
                    </label>
                </div>
            </div>
...
<script>
    function update() {
        ...
        var targetUrl ="http://localhost:80/manager/user/update";
        $.ajax({
            type:'post',
            url:targetUrl,
            cache: false,
