...
<script>
    function init(){
        $.ajax({
            url:"http://localhost:80/manager/customization/list",
            async: false,
            type:"get",
            dataType:"json",
                        ...
                        $.ajax({
                            ...
                            success:function(result){
                                ...
                                $.each(data.records,function(i,item){
                                    var edtior="<td class='center'><a href='http://localhost:80/manager/customization/detailView/"+item.id+"' title='预览' class='link_icon' >&#118;</a></td>";
                                    showTableHtml += "<tr>"+
