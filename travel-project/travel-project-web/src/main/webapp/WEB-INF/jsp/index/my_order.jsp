...
<div class="user_info">
    ...
    <div class="user_info_bg">
        <div class="user_info_portrait">
            <p class="user_info_name"><span>VIP专属:${user.username}:${user.username}</span></p>
    ...
    <div class="user_info_cont clear">
        ...
        <ul class="userinfo_left fl">
            ...
            <li class="active"  ><span class="icon_order"></span><a href="http://localhost:80/productOrder/orderView">我的订单</a></li>
            ...
            <c:forEach items="${orderLists}" var="item" >
                <div class="n_userorder_list">
                    <p class="n_userorder_tips">
                        ...
                        <a href="http://localhost:80/productOrder/detailView?pid=${item.pid}&oid=${item.oid}" class="userorder_view">查看详情</a>
                    </p>
