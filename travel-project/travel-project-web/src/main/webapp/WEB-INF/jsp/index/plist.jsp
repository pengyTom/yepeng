    ...
    <div class="custom">
        ...
        <div class="custom-around">
            <div class="custom-top">
                ...
                <ul class="custom-list custom-feature">
                    ...
                    <li value="自由行">
                        自由行                        </li>              </ul>
                <a class="theme-feature"  href="http://localhost:80/productlistView"> <p class="all_r">更多&gt;</p></a>
            </div>
        ...
        <div class="custom-around">
            <div class="custom-top">
                ...
                <a class="rim-all" href="http://localhost:80/productlistView"> <p class="all_r">更多&gt;</p></a>
            </div>
            <div class="tour-content ">
                <div class="ct-cn">
        ...
        <div class="custom-around">
            <div class="custom-top">
                ...
                <a class="civil-all" href="http://localhost:80/productlistView"> <p class="all_r">更多&gt;</p></a>
            </div>
            <div class="tour-content ">
                <div class="ct-cn">
...
<script>
    ...
    function init(){
        ...
        url="http://localhost:80/product/hot";
        data={
            size:5,
        };
        $.post(url,data,function(result){
